...
============================================================
Auto-generated for run: 20250624_083356
...
def validate_merges():
    ...
    log_file = Path("results/disambiguation/advanced_disambiguation_log_20250624_083356.json")
    ...
    if results:
        ...
        # Save results
        results_file = Path("results/disambiguation/advanced_validation_results_20250624_083356.json")
        results_file.parent.mkdir(parents=True, exist_ok=True)
        
        with open(results_file, 'w') as f:
            json.dump({
                'timestamp': '20250624_083356',
